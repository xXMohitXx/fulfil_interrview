...
def setup_database():
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            conn.execute(text("CREATE INDEX IF NOT EXISTS idx_upload_logs_status ON upload_logs(status)"))
            conn.execute(text("CREATE INDEX IF NOT EXISTS idx_webhooks_active ON webhooks(active)"))
